                    ...
                    <form id="create-article" method="POST" action="{{ route('article.store') }}"
                        ...
                        <div class="mx-auto">
                            <div class="border-b border-gray-300 relative mb-6 ">
                                <label for="title"
                                    class="block text-lg font-medium text-gray-700 dark:text-slate-100">Title</label>
                                <input type="text" placeholder="Give the Title for your article"
                                    class="block w-full py-2 px-3 border-0 outline-none focus:ring-0 placeholder-transparent dark:bg-slate-900 dark:text-slate-100"
                                    id="title" name="title" required>
                            </div>
                            <div class="border-b border-gray-300 relative mb-6">
                                <label for="intro"
                                    class="block text-lg font-medium text-gray-700 dark:text-slate-100">Intro</label>
                                <textarea placeholder="Write the Intro for your article"
                                    class="block w-full py-2 px-3 border-0 outline-none focus:ring-0 placeholder-transparent dark:bg-slate-900 dark:text-slate-100 resize-none"
                            ...
                            <div class="border-b border-gray-300 relative mb-6">
                                ...
                                <div
                                    ...
                                    <div class="form-check p-2 flex flex-col justify-center object-center">
                                        ...
                                        <input
                                            class="form-check-input tag-checkbox rounded border-gray-300 text-[#007bff] focus:ring-[#007bff] dark:text-[#5a32a3] dark:focus:ring-[#6f42c1]"
                                            type="checkbox" value="{{ $tag->id }}" id="tag{{ $tag->id }}" name="tags[]">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            {{-- add image upload with image preview .jpeg/.jpg/.png --}}
                            <img class="max-w-xs max-h-64 pb-5" id="imagePreview" src="#" alt="Image Preview"
                                style="display: none;">
                            ...
                            <div class="border-b border-gray-300 relative mb-6">
                                <label for="magazine_id"
                                    class="block text-lg font-medium text-gray-700 mb-2 dark:text-slate-100">Choose the
                                    Issue</label>
                                <select id="magazine_id" name="magazine_id"
                                    class="block w-full py-2 px-3 border-0 outline-none focus:ring-0 dark:bg-slate-900 dark:text-slate-100">
                            ...
                            <div class="flex items-center justify-between relative mb-6">
                                <label for="anon"
                                    class="block font-medium text-lg text-gray-700 dark:text-slate-100">Submit as
                                    Anonymous</label>
                                <div class="relative">
