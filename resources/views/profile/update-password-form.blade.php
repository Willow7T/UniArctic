<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4 ">
            ...
            <x-input id="current_password" name="current_password" type="password" class="mt-1 block w-full border-gray-300 border-2 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-200 
        ...
        <div class="col-span-6 sm:col-span-4 dark:text-slate-300">
            ...
            <x-input id="password" type="password" name="password" class="mt-1 block w-full border-gray-300 border-2 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-200 
            focus:outline-none focus:border-blue-800 focus:ring-blue-800 dark:focus:border-purple-600 dark:focus:ring-purple-600
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full border-gray-300 border-2 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-200 
            focus:outline-none focus:border-blue-800 focus:ring-blue-800 dark:focus:border-purple-600 dark:focus:ring-purple-600
