...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <!-- Scripts -->
    ...
    <body class="antialiased">
        ...
        <section>
            <div class="absolute z-10 -left-4 bottom-2 flex">
               
                {{-- <div class="p-4">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique atque aperiam ipsum maxime ad cumque officia perferendis officiis. Consectetur, quo harum delectus eveniet eos dolores tempore iure non id? Libero.
                </div>
                <div class="p-4">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique atque aperiam ipsum maxime ad cumque officia perferendis officiis. Consectetur, quo harum delectus eveniet eos dolores tempore iure non id? Libero.
                </div>
